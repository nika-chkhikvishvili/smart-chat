...
<div class="col-lg-9">
<input class="form-control" id="cname" name="template_title_ge" value='<?php echo $sql_templates['template_title_ge'];?>' type="text">
...
<div class="col-md-10">
    <textarea class="form-control" rows="5" name="template_text_ge"><?php echo $sql_templates['template_text_ge'];?></textarea>
</div>
</div>     
<div class="form-group">
...
<div class="col-lg-9">
<input class="form-control" id="cname" name="template_title_ru" value='<?php echo $sql_templates['template_title_ru'];?>' type="text" >
</div>
</div>
<div class="form-group">
<label class="col-md-2 control-label">შაბლონის ტექსტი</label>
<div class="col-md-10">
    <textarea class="form-control" rows="5" name="template_text_ru"><?php echo $sql_templates['template_text_ru'];?></textarea>
</div>
</div>       
<div class="form-group">
...
<div class="col-lg-9">
<input class="form-control" id="cname" name="template_title_en" value='<?php echo $sql_templates['template_title_en'];?>' type="text" >
</div>
</div>  
<div class="form-group">
<label class="col-md-2 control-label">შაბლონის ტექსტი</label>
<div class="col-md-10">
    <textarea class="form-control" rows="5" name="template_text_en"><?php echo $sql_templates['template_text_en'];?></textarea>
</div>
</div>  
