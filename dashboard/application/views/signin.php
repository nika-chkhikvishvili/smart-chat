                ...
                <form name="form" id="form" class="form-horizontal" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12 controls">
                            <button type="submit" href="#" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-log-in"> </i>&nbsp;შესვლა</button>                          
                        </div>
						
                    </div>
						<p class="help-block">
						<a class="pull-right text-muted" href="<?=base_url();?>resetpass" id="olvidado"><small>დაგავიწყდა პაროლი?</small></a>
