<ul>
    ...
    <li class="has_sub">
        <a href="#" class="waves-effect"><i class="md md-mail"></i><span>შეტყობინებები</span><span class="pull-right"><i class="md md-add"></i></span></a>
    ...
    <li class="has_sub">
        <a href="#" class="waves-effect"><i class="md md-palette"></i> <span> ადმინისტრირება </span> <span class="pull-right"><i class="md md-add"></i></span></a>
        <ul class="list-unstyled">
    ...
    <li class="has_sub">
        <a href="<?=base_url();?>dashboard/persons" class="waves-effect"><i class="md md-share"></i><span>მომხმარებლები</span><span class="pull-right"><i class="md md-add"></i></span></a>
        <ul>
            <li class="has_sub">
